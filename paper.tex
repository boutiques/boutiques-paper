...
\item Workflow engines can be platforms (they can run Boutiques applications), workflows can be applications (they can be described in Boutiques).
...
The \boutiques specification adopts a bottom-up approach where new
features are progressively added when applications or platforms
require them. It is currently supported by \todo{X} platforms and  \todo{Y} applications
were described.

 Although the motivating use cases
...
workflow engines are specific applications that need complex languages to
