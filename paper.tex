...
that all the pipeline parameters were fixed, to facilitate execution.

The Nipype workflow engine~\cite{gorgolewski2011nipype} was
...
Other neuroinformatics tools were ported to CBRAIN using Boutiques:
FSL tools and ICA AROMA are available at
\url{https://github.com/aces/cbrain-plugins-neuro} and some
pipelines of the Human Connectome Project (HCP) are at
