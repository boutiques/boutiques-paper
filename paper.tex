...
Until recently, applications were integrated in VIP as workflows defined and managed 
with the MOTEUR\cite{GLAT-08} workflow engine. As of today, Boutiques is supported 
through a "Boutiques application importer" tool allowing to automatically import
applications based on their JSON description. 

\todo{Sorina, Tristan: develop on the functionalities and current limits of the application importer?}
