...
\author{Tristan Glatard, Tristan Aumentado-Armstrong, Natacha Beck, Pierre Bellec,\\
        ...
        Nathaniel Kofalt, Pierre-Olivier Quirion, Pierre Rioux, Gunnar Schaeffer,\\
        Marc-\'Etienne Rousseau, Alan C. Evans}
...
\begin{enumerate}
\item Applications write a JSON object complying to the invocation schema in the directory where there were launched.
\item The platform reads the JSON object, creates the corresponding task, and writes back the task id in the same directory.
