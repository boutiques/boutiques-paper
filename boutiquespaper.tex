...
Docker (\url{https://www.docker.com}) and
...
on
NeuroLinks (\url{https://brainhack101.github.io/neurolinks}),
...
NipBIDS (\url{https://github.com/big-data-lab-team/sim/tree/master/sim/other_wf_examples/nipype}),
...
Infrastructure (\url{https://www.egi.eu}). The biomed VO
...
service (\url{https://dirac.france-grilles.fr}) to execute
...
Anima (\url{https://github.com/Inria-Visages/Anima-Public/wiki})
...
\paragraph{GinFizz}
We integrated the
GinFizz (\url{https://github.com/thomashirsch/ginfizz})
...
package~\cite{tournier2012mrtrix} (\url{http://www.mrtrix.org}) for diffusion MRI processing were also made available in VIP,
...
\paragraph{ODIN} The Odin MRI simulator~\cite{jochimsen2004odin} (\url{http://od1n.sourceforge.net}) was integrated
...
images (MSSEG
challenge -- \url{https://portal.fli-iam.irisa.fr/msseg-challenge/overview})
...
\item A pipeline
  ...
  \texttt{nvidia-docker} (\url{https://github.com/NVIDIA/nvidia-docker})
...
(CWL -- \url{http://www.commonwl.org}) is the work most closely
...
Description (\url{http://www.commonwl.org/v1.0/CommandLineTool.html}). According
...
Toolkit (\url{http://www.commontk.org}) interoperates with
