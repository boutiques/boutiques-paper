...
on
\href{https://brainhack101.github.io/neurolinks}{NeuroLinks},
...
\href{http://github.com/aces/cbrain}{CBRAIN}~\cite{SHER-14} is a web
...
\href{http://nipype.readthedocs.io/en/latest}{Nipype}
~\cite{gorgolewski2011nipype}
...
\href{https://github.com/big-data-lab-team/sim/tree/master/sim/other_wf_examples/nipype}{NipBIDS},
...
\subsubsection{SPINE}
\href{http://spinevirtuallab.org}{SPINE}, which stands for Structured
...
Infrastructure (\href{http://www.egi.eu}{EGI}). The biomed VO
...
laboratory in Lyon
and it uses the \href{https://dirac.france-grilles.fr}{DIRAC} French national
service to execute
...
\href{https://github.com/Inria-Visages/Anima-Public/wiki}{Anima}
...
application. The resulting CBRAIN plugin is available on 
\href{https://github.com/SIMEXP/cbrain-plugins-psom}{GitHub}.  
Descriptors are on Neurolinks.

\paragraph{GinFizz}
We integrated the
\href{https://github.com/thomashirsch/ginfizz}{GinFizz}
...
\paragraph{MRTrix3}
A few applications from the \href{http://www.mrtrix.org}{MRtrix3}
package~\cite{tournier2012mrtrix} for diffusion MRI processing were also made available in VIP,
...
exported to \boutiques and is available \href{online}{https://github.com/neurodata/boutiques-tools}.
...
\paragraph{ODIN} The \href{http://od1n.sourceforge.net}{Odin} MRI simulator~\cite{jochimsen2004odin} was integrated
...
images (\href{https://portal.fli-iam.irisa.fr/msseg-challenge/overview}{MSSEG}
challenge)
...
\item A pipeline
  ...
  \href{https://github.com/NVIDIA/nvidia-docker}{nvidia-docker}
...
(\href{http://www.commonwl.org}{CWL}) is the work most closely
...
version 1.0 of the CWL \href{http://www.commonwl.org/v1.0/CommandLineTool.html}{Command Line Tool
...
command-line applications. Among them, the \href{http://www.commontk.org}{Common
Toolkit} interoperates with
