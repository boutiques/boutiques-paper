...
\affil[7]{Wellcome Trust Centre for Neuroimaging}
...
Nipype-based fMRI pre-processing pipeline in VIP with \boutiques. 
A few technical issues were encountered with the Docker container. 
They were mainly due to the re-use of multiple containers build 
with specific users, leading to file access issues. We therefore 
had to override the permissions on the files and folders necessary
to the correct execution of the GinFizz application. 
...
\paragraph{CreaPhase}
A phase contrast simulator called CreaPhase\cite{WEBE-17}, developed at Creatis, was
