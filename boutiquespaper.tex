...
\author{Tristan Glatard, Tristan Aumentado-Armstrong, Natacha Beck, Pierre Bellec,\\
        ...
        Krzysztof J. Gorgolewski, Charles G. Guttmann, Gregory Kiar, Nathaniel Kofalt, \\
...
%% gk: I think we should remove this and just have the reference in Publisher
...
The following platforms are currently able to integrate and execute Boutiques
applications. 
...
smoothing (spatial filtering to increase Signal to Noise ratio). The use of Docker containers (\url{https://hub.docker.com/r/fliiam/ginfizz} based on \url{https://hub.docker.com/r/miykael/nipype_level2}) 
greatly simplifies its deployment. The animaN4BiasCorrection tool from the Anima  \footnote{\url{https://github.com/Inria-Visages/Anima-Public/wiki}} project was also made available 
